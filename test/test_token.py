...
logger.info(
    f"SECURITY_PASSWORD_SALT: {'set' if os.environ.get('SECURITY_PASSWORD_SALT') else 'not set'}"
)
logger.info(
    f"SECURITY_PASSWORD_PEPPER: {'set' if os.environ.get('SECURITY_PASSWORD_PEPPER') else 'not set'}"
)
